...
[![version](https://img.shields.io/badge/release-v0.6.1-success)](https://github.com/udibo/collections/tree/v0.6.1)
[![deno doc](https://img.shields.io/badge/deno-doc-success?logo=deno)](https://doc.deno.land/https/deno.land/x/collections@v0.6.1/mod.ts)
...
import { Vector } from "https://deno.land/x/collections@v0.6.1/mod.ts";
// Import from GitHub
import { Vector } "https://raw.githubusercontent.com/udibo/collections/v0.6.1/mod.ts";
```
...
```ts
// Import from Deno's third party module registry
import { Vector } from "https://deno.land/x/collections@v0.6.1/vector.ts";
// Import from GitHub
import { Vector } from "https://raw.githubusercontent.com/udibo/collections/v0.6.1/vector.ts";
```
...
```js
import { Vector } from "./collections_v0.6.1.js";
```
...
```js
import { Vector } from "./collections_v0.6.1.mjs";
```
...
See [deno docs](https://doc.deno.land/https/deno.land/x/collections@v0.6.1/mod.ts#Vector) for more information.
...
See [deno docs](https://doc.deno.land/https/deno.land/x/collections@v0.6.1/mod.ts#BinaryHeap) for more information.
...
import { ascend } from "https://deno.land/x/collections@v0.6.1/comparators.ts";
...
See [deno docs](https://doc.deno.land/https/deno.land/x/collections@v0.6.1/mod.ts#BSTree) for more information.
...
See [deno docs](https://doc.deno.land/https/deno.land/x/collections@v0.6.1/mod.ts#RBTree) for more information.
