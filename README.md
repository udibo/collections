...
[![version](https://img.shields.io/badge/release-v0.10.0-success)](https://github.com/udibo/collections/tree/v0.10.0)
[![deno doc](https://img.shields.io/badge/deno-doc-success?logo=deno)](https://doc.deno.land/https/deno.land/x/collections@v0.10.0/mod.ts)
...
import { Vector } from "https://deno.land/x/collections@v0.10.0/mod.ts";
// Import from GitHub
import { Vector } "https://raw.githubusercontent.com/udibo/collections/v0.10.0/mod.ts";
```
...
```ts
// Import from Deno's third party module registry
import { Vector } from "https://deno.land/x/collections@v0.10.0/vector.ts";
// Import from GitHub
import { Vector } from "https://raw.githubusercontent.com/udibo/collections/v0.10.0/vector.ts";
```
...
```js
import { Vector } from "./collections_v0.10.0.js";
```
...
```js
import { Vector } from "./collections_v0.10.0.mjs";
```
...
See [deno docs](https://doc.deno.land/https/deno.land/x/collections@v0.10.0/mod.ts#Vector) for more information.
...
See [deno docs](https://doc.deno.land/https/deno.land/x/collections@v0.10.0/mod.ts#BinaryHeap) for more information.
...
```ts
import { BinaryHeap } from "https://deno.land/x/collections@v0.10.0/binary_heap.ts";
import { ascend } from "https://deno.land/x/collections@v0.10.0/comparators.ts";
...
See [deno docs](https://doc.deno.land/https/deno.land/x/collections@v0.10.0/mod.ts#BSTree) for more information.
...
See [deno docs](https://doc.deno.land/https/deno.land/x/collections@v0.10.0/mod.ts#RBTree) for more information.
