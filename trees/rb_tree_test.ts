...
Deno.test("RBTree with descend comparator", () => {
...
Deno.test("RBTree from Iterable", () => {
...
Deno.test("RBTree from RBTree with default ascend comparator", () => {
  const values: number[] = [-10, 9, -1, 100, 9, 1, 0, 9, -100, 10, -9];
  const expected: number[] = [-100, -10, -9, -1, 0, 1, 9, 10, 100];
...
Deno.test("RBTree from RBTree with descend comparator", () => {
  const values: number[] = [-10, 9, -1, 100, 9, 1, 0, 9, -100, 10, -9];
  const expected: number[] = [100, 10, 9, 1, 0, -1, -9, -10, -100];
...
Deno.test("RBTree insert rebalance left", () => {
...
Deno.test("RBTree insert rebalance right", () => {
...
Deno.test("RBTree remove rebalance root", () => {
  let values: number[] = [0];
  let tree: RBTree<number> = RBTree.from(values);
...
Deno.test("RBTree remove rebalance left", () => {
  let values = [4, 5, 0];
...
Deno.test("RBTree remove rebalance right", () => {
  let values = [-4, -5, 0];
  let tree = RBTree.from(values);
